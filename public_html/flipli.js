//Web Image Designs - 2014
//Author: Kyle Vedder
$(function()
{
    //===== Note: All following numbers are times in milliseconds =====//
    var fadeInTime = 500;
    var visibleTime = 2000;//how long each element is visible
    var fadeOutTime = 500;
    var delayBetweenDisplays = 0;//time delay between fade out of one element and the fade in of the next	

    //===== Random Start Position =====//
    var randomStartPosition = true;//if true, starts at a random phrase in the list, if false starts at the first phrase in the list
